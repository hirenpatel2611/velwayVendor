...
export default class MultiSlider extends React.Component {
  ...
  startOne = () => {
    if (this.props.enabledOne) {
      ...
      this.overLapped=(positionOne==positionTwo);
  ...
  moveOne = (gestureState) => {
    ...
    const accumDistance = this.props.vertical?this.props.upsideDown?gestureState.dy: -gestureState.dy : gestureState.dx;
  ...
  render() {
    ...
    const markerContainerOne = { top: markerOffsetY - 24, left: trackOneLength + markerOffsetX - 24,zIndex:this.state.topViewOne }

    const markerContainerTwo = { top: markerOffsetY - 24, right: trackThreeLength + markerOffsetX - 24,zIndex:this.state.topViewTwo };
